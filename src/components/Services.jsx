...
<div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
    <img className='w-full h-full object-cover md:object-right' width={800} src={service1} alt="Smartest AI" height={730} />
</div>
...
<Generating className='absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2'/>
    ...
    <PhotoChatMessage/>
            ...
            <div className='p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]'>
                <div className='py-112 px-4 xl:px-8'>
                ...
                <div className="relative h-[20rem] mt-20 rounded-xl bg-n-8 overflow-hidden md:h-[25rem]">
